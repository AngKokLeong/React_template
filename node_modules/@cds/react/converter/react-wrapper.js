 ...
 */
export const createComponent = (tagName, elementClass, events) => {
    ...
    class ReactComponent extends Component {
        ...
        _updateElement(oldProps) {
            ...
            for (const prop in this._elementProps) {
                setProperty(this._element, prop, this.props[prop], oldProps ? oldProps[prop] : undefined, // edit, cast to any as it causes error TS2590 - Cory
                events);
            }
        ...
        componentDidMount() {
            ...
            if (window.CDS && !window.CDS._react.version) {
    ...
    ReactComponent.displayName = `${tagName}(CustomElement)`; // edit to preserve component name in DevTools - Cory
    const element = React.forwardRef((props, ref) => createElement(ReactComponent, Object.assign(Object.assign({}, props), { __forwardedRef: ref }), props === null || props === void 0 ? void 0 : props.children));
